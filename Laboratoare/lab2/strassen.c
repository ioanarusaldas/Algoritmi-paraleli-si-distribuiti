...
int main(int argc, char *argv[])
{
	get_args(argc, argv);
	init();
	//real    0m20.961s neparalelizat
	//real    0m15.782s paralelizat  
	...
	for (i = 0; i < NUM_THREADS; i++) {
		...
		switch(i){
			case 0:
					...
					r = pthread_create(&threads[i], NULL, fM1, &arguments[i]);
					break;
			case 1:
								r = pthread_create(&threads[i], NULL, fM2, &arguments[i]);
					break;
			case 2:
			
			
					r = pthread_create(&threads[i], NULL,fM3, &arguments[i]);
					break;
			case 3:
		
					r = pthread_create(&threads[i], NULL, fM4, &arguments[i]);
					break;
			case 4:
					r = pthread_create(&threads[i], NULL, fM5, &arguments[i]);
					break;
			case 5:
			
					r = pthread_create(&threads[i], NULL, fM6, &arguments[i]);
					break;
			case 6:
		
					r = pthread_create(&threads[i], NULL, fM7, &arguments[i]);
					break;
			default:
				break;
		}
